(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('riot'), require('@riotjs/dom-bindings')) :
    typeof define === 'function' && define.amd ? define(['exports', 'riot', '@riotjs/dom-bindings'], factory) :
    (global = global || self, factory(global.route = {}, global.riot, global.riotDOMBindings));
}(this, (function (exports, riot, domBindings) { 'use strict';
      ...
      'exports': riot.pure(({ slots, attributes, props }) => {
        ...
        return {
          ...
          createSlot(context) {
            ...
            this.slot = domBindings.template(null, [{
              type: domBindings.bindingTypes.SLOT,
              name: 'default'
            }]).mount(this.el, {
              slots
            }, context);
