<template>
    <div ref="root" @click="snapToCursor" @keydown="onKeyDown" @dragstart="onDragStart" @dragend="endDrag"
        draggable="true" tabindex="-1" class="cursor-pointer group relative h-1.5 rounded-full bg-ls-300">
        <div class="absolute h-full rounded-full bg-accent-500" :style="`width: ${100 * model}%`" />
