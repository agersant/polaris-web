<async-button>
	<button onClick={ opts.action } disabled={ opts.disabled || currentState.disabled } type={ opts.submit ? "submit" : "button" } class={ submit: opts.submit, success: currentState.success, failure: currentState.failure }>
		<div class="status">
